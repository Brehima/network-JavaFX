...
public class Coursesservice implements CoursesserviceRemote, CoursesserviceLocal {
	...
	public int count_courses () {
		// TODO Auto-generated method stub
		Query query = em.createQuery("select count c from Courses c ");
		Object res =  query.getSingleResult();
		int x = ((Number) res).intValue();
		print ("****************",x) ; 
		return x;
	}
	...
	
	{
		...
		Query query = em.createQuery("SELECT SUM(c.price) FROM Course c");
		Object res =  query.getSingleResult();
	...
	private void print(String string, int x) {
		// TODO Auto-generated method stub
