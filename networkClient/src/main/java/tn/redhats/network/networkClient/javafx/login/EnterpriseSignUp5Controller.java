 ...
 * @author lenovo
 */
public class EnterpriseSignUp5Controller implements Initializable {
    ...
    public static String adminCode="", HRCode="", ProjectsManagerCode="", RecruitementsCode="";
    ...
    private void clicBackButton(ActionEvent event) throws IOException {
    	FXMLLoader loader=new FXMLLoader(getClass().getResource("/fxml/enterpriseSignUp4.fxml")); 
    ...
    private void clicNextButton(ActionEvent event) throws IOException {
    	...
    	adminCode = SigninController.generateCode();
    	HRCode = SigninController.generateCode();
    	ProjectsManagerCode = SigninController.generateCode();
    	RecruitementsCode = SigninController.generateCode();
    	SigninController.sendEmailBySSl(adminCode, EnterpriseSignUp2Controller.staticEmail);
    	SigninController.sendEmailBySSl(HRCode, EnterpriseSignUp3Controller.staticEmail);
    	SigninController.sendEmailBySSl(ProjectsManagerCode, EnterpriseSignUp4Controller.staticEmail);
    	SigninController.sendEmailBySSl(RecruitementsCode, EnterpriseSignUp5Controller.staticEmail);
