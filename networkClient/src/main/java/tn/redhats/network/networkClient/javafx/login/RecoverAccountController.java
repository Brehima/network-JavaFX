...
public class RecoverAccountController implements Initializable {
    ...
    @FXML
    private JFXButton recoveryButton;
    @FXML
    ...
    @FXML
    private void clicRecovery(ActionEvent event) throws IOException {
    	if(SigninController.recoveryCode.equals(codeTextField.getText())) {
